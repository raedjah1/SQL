-- ============================================================================
-- Serial First Pass Yield - Location Filtered Report
-- ============================================================================
-- Purpose: Individual serial first pass analysis with GCF errors and location tracking
--          Filters: Serials in FinishedGoods.ARB.0.0.0 or moved FROM there TO FinishedGoods/Reserve
-- ============================================================================
