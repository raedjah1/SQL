-- GCF Errors - Basic Fields + Family Lookup + Comprehensive Categorization
-- Updated with comprehensive error categorization matching Excel logic
...
SELECT 
    ...
    DATEADD(DAY, 7 - DATEPART(WEEKDAY, CAST(gcf.Insert_Date AS DATE)), CAST(gcf.Insert_Date AS DATE)) AS [EOW],
