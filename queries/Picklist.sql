...
SELECT 
    -- Drop Date (Order Create Date from SOHeader - matches ECR Dashboard)
    sh.CreateDate AS DropDate,
...
GROUP BY 
    sh.CreateDate,  -- Changed from sl.CreateDate to sh.CreateDate to match ECR Dashboard
