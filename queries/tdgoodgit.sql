...
INNER JOIN Plus.pls.PartLocation pl_to ON pl_to.LocationNo = pt.ToLocation
    ...
    AND UPPER(LTRIM(RTRIM(pl_to.Warehouse))) = 'INDEMANDGOODPARTS'
...
-- Get parent serial for Family and LOB
CROSS APPLY (
...
-- LOB from Parent Serial/Service Tag (optimized lookup - gets latest value)
OUTER APPLY (
