...
-- ACTUAL COLUMNS: ID, CustomerReference, ProgramID, PartNo, SerialNo, RepairTypeDescription,
-- WorkstationDescription, IsPass, StatusDescription, Username, CreateDate, LastActivityDate
SELECT 
    'Work Order Status Pattern' as QueryType,
    'Work Order master data with quality results and workstation tracking' as Pattern,
    'Example: SELECT * FROM pls.vWOHeader WHERE IsPass = 0 OR StatusDescription LIKE ''%Failed%''' as ExampleQuery;
